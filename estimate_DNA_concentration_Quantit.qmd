...
::: column-page
![](images/Quant-iT_quick_guide.png)
:::
...
![Data format for automatic ASCII export](images/data_format.png){#fig-dataformat}
...
![Protocol for fluorescence reading on the Omega software](images/protocol.PNG){#fig-protocol}
...
![Saving raw data from the Omega software](images/protocol2.PNG){#fig-reading}
